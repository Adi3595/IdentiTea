import { Share2, Globe, Eye, Code } from "lucide-react";
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch">
              <code className="flex-1 bg-foreground/5 border-2 border-foreground sm:border-r-0 px-4 py-3 text-sm font-mono truncate">
                identitea.com/u/agent-zero
              </code>
              <Button className="rounded-none border-2 border-foreground bg-foreground text-background font-bold uppercase tracking-widest h-auto py-3">
